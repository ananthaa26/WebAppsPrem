        ...
        <div class="w">
            <div class="topbar-inner">
                <a href="#" class="logo-link">
                    <img src="https://cdn.zannstore.com/assets/project/zannstore/2022profileBrand.webp" alt="ZANNSTORE" class="logo-img">
                </a>
        ...
        <div class="w">
            ...
            <footer class="footer">
                <div class="footer-top">
                    <div class="logo-text">ZANNSTORE</div>
                    <p>Toko langganan premium terpercaya. Proses otomatis, bergaransi, harga bersahabat.</p>
                </div>
                ...
                <div class="footer-bot">&copy; 2026 ZANNSTORE. Made with ❤️ for Indonesia</div>
            </footer>
